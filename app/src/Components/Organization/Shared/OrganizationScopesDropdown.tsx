...
import { type Scope } from '../../Auth/Scopes/model/scopes';
import { type ApiCollectionResponse } from '../../../config/data/response/response';

const ORGANIZATION_SCOPE_ROOT = 'organizations';

interface OrganizationScopesDropdownProps {
...
/**
 * Dropdown that lists only scopes under the `organizations` root, keeping
 * organization ACL assignment strictly separated from admin scopes.
 */
export const OrganizationScopesDropdown: React.FC<OrganizationScopesDropdownProps> = ({ selectedValues, onChange, className }) => {
    ...
    useEffect(() => {
        const fetchScopes = async () => {
            ...
            try {
                ...
                rootScopes
                    .filter((scope) => scope.id === ORGANIZATION_SCOPE_ROOT)
                    .forEach((scope) => {
            ...
            <div className="mb-4 flex flex-col sm:flex-row gap-4">
                <div className="relative flex-grow">
                    ...
                    <FormInput
                        ...
                        placeholder="Search organization scopes..."
...
export default OrganizationScopesDropdown;
